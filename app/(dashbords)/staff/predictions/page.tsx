...
export default async function StaffPredictionsPage() {
  ...
  const [environmental] = await Promise.all([
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <Button asChild className="gap-1.5 shrink-0">
          <Link href="/staff/environmental">Upload New Surveillance</Link>
        </Button>
      </div>
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <Button asChild size="sm" variant="destructive" className="text-xs">
                    <Link href="/staff/validate">Triage Cases in {alert.district}</Link>
                  </Button>
                </div>
              </div>
            </div>
