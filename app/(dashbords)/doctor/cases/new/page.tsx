...
import { submitDiseaseCase } from "@/actions/doctor/cases";
...
export default function SubmitDiseaseCasePage() {
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-xs text-muted-foreground">· Clinician Record Entry</span>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="rounded-xl border bg-card p-5 space-y-4">
          <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">
            3. Treatment Initiated & Attending Physician Notes
          </p>
        ...
        <div className="flex items-center justify-between">
          <Button asChild variant="outline">
            <Link href="/doctor/cases">Cancel</Link>
          </Button>
